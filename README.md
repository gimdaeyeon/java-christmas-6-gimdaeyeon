...
- [x] 입력받은 메뉴, 개수로 주문리스트 만들기

### 날짜
- [x] 입력받은 날짜가 평일인지 주말인지 확인
- [x] 입력받은 날짜에 특별할인이 적용되는지 확인

### 할인
- [x] 입력받은 날짜로 크리스마스 디데이 할인금액 구하기
- [x] 방문날짜가 평일일 때 적용되는 할인금액 계산 
- [x] 방문날짜가 주말일 때 적용되는 할인금액 계산 
- [x] 방문날짜가 특별 할인 적용날짜일 때 적용되는 할인금액 계산 
- [x] 총 주문 금액이 120000원 이상인지 확인(25,000 샴페인 증정)
- [x] 적용된 모든 할인 금액 계산
- [ ] 혜택 금액에 따라 이벤트 배지 부여
